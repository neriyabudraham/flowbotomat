...
const saveContactBotController = require('../controllers/webhook/saveContactBot.controller');
...
// WhatsApp Cloud API webhook (Status Bot) - no auth required (Meta calls this)
...
// Save Contact Bot webhook (separate WABA) - no auth required (Meta calls this)
// URL format: /api/webhook/save-contact-bot
router.get('/save-contact-bot', saveContactBotController.verifyWebhook);
router.post('/save-contact-bot', saveContactBotController.handleWebhook);
