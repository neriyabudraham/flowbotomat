...
export default function SystemAlertOverlay() {
  ...
  return (
    <>
      {/* BOTTOM BANNER - Shows countdown after user acknowledges */}
      {updateCountdown !== null && acknowledged && (
        <div className="fixed bottom-0 left-0 right-0 z-[9999] animate-slide-up" dir="rtl">
          <div className={`${updateCountdown <= 0 ? 'bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600' : 'bg-gradient-to-r from-amber-600 via-orange-600 to-red-600'} text-white py-3 px-4 shadow-lg`}>
            <div className="max-w-4xl mx-auto flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  {updateCountdown <= 0 ? (
                    <p className="font-medium text-sm">מתעדכן עכשיו... העמוד יתרענן אוטומטית</p>
                  ) : (
                    <p className="font-medium text-sm">עדכון מערכת - יש להמתין לסיום העדכון</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 bg-white/20 px-3 py-1.5 rounded-lg">
                {updateCountdown <= 0 ? (
                  ...
                  <>
                    ...
                    <span className="text-lg font-bold tabular-nums">{updateCountdown}</span>
